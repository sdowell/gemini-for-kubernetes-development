...
func (w *Watcher) newIssueScanner() *issues.Scanner {
	return issues.New(issues.Config{
		...
		RateLimitBackoff:    issues.DefaultRateLimitBackoff,
		MaxRateLimitBackoff: issues.DefaultMaxRateLimitBackoff,
		DryRun:              w.DryRun,
	}, issues.Deps{
		GitHub:    w.repoClient,
		Queue:     w.queueMgr,
...
func (w *Watcher) newPRScanner() *prs.Scanner {
	return prs.New(prs.Config{
		...
		RateLimitBackoff:    prs.DefaultRateLimitBackoff,
		MaxRateLimitBackoff: prs.DefaultMaxRateLimitBackoff,
		DryRun:              w.DryRun,
	}, prs.Deps{
		GitHub:    w.repoClient,
		Queue:     w.queueMgr,
